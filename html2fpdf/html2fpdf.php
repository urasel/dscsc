...
function HTML2FPDF($orientation='L',$unit='pt',$format='A4')
{
//! @desc Constructor
//! @return An object (a class instance)
  ...
  $this->lineheight = 15; // Related to FontSizePt == 11
  ...
  $this->address = '<a href="swapnoloke@gmail.com">swapnoloke@gmail.com</a>';
...
//! @desc The header is printed in every page.
  if($this->usetableheader and $content != '')
  {
	...
	if($this->header_flag){
		//$this->header_image
		//if($this->PageNo()==1){
		//	$this->Image($this->header_image,10,8,33);
		//}
		
		if(!empty($this->title) && $this->PageNo()!=1){
			$this->SetY(5);
			$this->SetFont('Arial', 'B', 8);
			//$this->Cell(80);
			$this->Cell(0, 0, $this->title, 0, 0, 'R');
			$this->Ln(4);
...
//! @desc The footer is printed in every page!
    ...
    //Page number
   	//$this->MultiCell(0,5,$this->address,0,$align='J',$fill=0,$this->address);
   
    $this->Cell(0,10,$this->PageNo().'/{nb}',0,0,'C');
	$this->SetY(-10);
	//$this->Image('report/header.jpg',10,8,33);
