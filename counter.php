...
// ################################################
	...
	global $Config_host, $Config_user, $Config_password, $Config_db, $dbtablehits,$dbtableinfo,$maxrows;
/*
	...
	$dbselect=mysql_select_db($Config_db);
	if (!$dbselect)
	{
    	die ("Can't use database $Config_db! : " . mysql_error()); // remove ?
	}*/
